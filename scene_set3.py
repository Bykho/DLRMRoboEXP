...
stapler = stapler_loader.load(os.path.join(repo_root, "assets/objects/pot/mobility.urdf"))
...
cabinet = cabinet_loader.load(os.path.join(repo_root, "assets/objects/cabinet4/mobility.urdf"))
...
plt.imsave(os.path.join(scene_set_dir, "top_view3.png"), rgb)
print(f"✅ Scene photo saved to {scene_set_dir}/top_view3.png")
